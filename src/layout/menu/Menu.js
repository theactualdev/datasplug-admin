...
//       {newTab ? (
//         <Link
//           to={`${import.meta.env.PUBLIC_URL + link}`}
//           target="_blank"
...
//         <li className={menuItemClass}>
//           <Link to={`${import.meta.env.PUBLIC_URL}/`} className="nk-menu-link" onClick={() => setMenuData(menu)}>
//             <span className="nk-menu-icon">
...
// //       if (item.panel) {
// //         let found = item.subPanel.find((sPanel) => import.meta.env.PUBLIC_URL + sPanel.link === window.location.pathname);
// //         if (found) {
