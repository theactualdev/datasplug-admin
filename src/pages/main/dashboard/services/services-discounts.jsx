...
const ServicesDiscounts = () => {
  ...
  const { isLoading, data } = useGetDiscounts("service", serviceName);
  ...
  return (
    <React.Fragment>
      <Head title={`${serviceName} Discounts`}></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>{serviceName} Discounts</BlockTitle>
            </BlockHeadContent>
            <BlockHeadContent>
...
export default ServicesDiscounts;
