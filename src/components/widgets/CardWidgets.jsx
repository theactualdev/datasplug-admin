...
const CardWidgets = () => {
  ...
  return (
              ...
              <Col md="5" sm="7">
                <Card className="card-bordered product-card">
                  <div className="product-thumb">
                    <Link to={`${import.meta.env.PUBLIC_URL}/product-details/1`}>
                  ...
                  <div className="card-inner text-center">
                    <ul className="product-tags">
                      <li>
                        <Link to={`${import.meta.env.PUBLIC_URL}/product-details/1`}>Smart Watch</Link>
                      </li>
                    </ul>
                    <h5 className="product-title">
                      <Link to={`${import.meta.env.PUBLIC_URL}/product-details/1`}>Classy Smart Watch</Link>
                    </h5>
                ...
                <PreviewAltCard>
                  <div className="team">
                    ...
                    <div className="team-view">
                      <Link
                        to={`${import.meta.env.PUBLIC_URL}/user-details-regular/1`}
    ...
    <div className="team-view">
        <Link to={import.meta.env.PUBLIC_URL}/user-details-regular/1}>
      ...
      <div className="card-inner">
        <div className="card-title-group">
          ...
          <div className="card-tools">
            <Link to={import.meta.env.PUBLIC_URL}/user-list-regular} className="link">
              View All
            </Link>
          </div>
        </div>
    ...
    <React.Fragment>
      <div className="card-inner border-bottom">
        <div className="card-title-group">
          ...
          <div className="card-tools">
            <Link to={{import.meta.env.PUBLIC_URL}/app-messages} className="link">
              All Tickets
            </Link>
          </div>
        </div>
